    ...
    <div className="w-full bg-white rounded-3xl shadow-xl p-6 sm:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {benefits.slice(0, 4).map((b) => (
          <div 
            key={b.id} 
            // 🌟 Key Change 2: Individual Card Styling - Lighter shadow, slight hover effect
            className="bg-gray-50 rounded-xl shadow-md flex flex-col h-full border border-gray-100 transition duration-300 hover:shadow-lg hover:border-teal-200"
          >
